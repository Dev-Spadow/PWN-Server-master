 			...
 			loop: while((string = reader.readLine()) != null) {
 				...
 				default:
 					...
 					case "pernix_armour_set":
 						player.getInventory().add(14012, quantity).add(14013, quantity);
 						break;
 					...
 					case "third-age_mage_set":
 						player.getInventory().add(1, quantity);
 						break;
 					...
 					case "partyhat_set":
 						...
 						/** THIRD AGE SET **/
 					case "third-age_set":
 						int[] thirdAgeSet = new int[]{11858, 11860, 1, 19308, 19317, 19320, 19341};
 					...
 					case "nex_armour_sets":
 						int[] nexSets = new int[]{14008, 14009, 14010, 14012, 14013, 14014, 14015, 14016};
