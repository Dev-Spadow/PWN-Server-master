...
public class Runecrafting {
	...
	public static void craftRunes(final Player player, RunecraftingData.RuneData rune) {
		...
		for(int i = 28; i > 0; i--) {
            ...
            DailyTasks.INSTANCE.updateTaskProgress(TaskType.RUNECRAFTING, player, essence, 1);
            DailyTasks.INSTANCE.updateTaskProgress(TaskType.RUNECRAFTING, player, rune.getRuneID(), amountToMake);
		}
