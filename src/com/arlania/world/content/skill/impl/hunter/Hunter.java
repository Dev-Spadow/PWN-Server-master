...
public class Hunter {
	...
	public static void lootTrap(Player client, GameObject trap, int chance) {
		if (trap != null) {
					...
					if (theTrap.getOwner() == client) {
						if (theTrap instanceof SnareTrap) {
							...
							if (theTrap.getGameObject().getId() == 19180) {
								...
								client.getInventory().add(10835, 2);
								client.getPacketSender().sendMessage("@red@You've just received " + 10 + " skilling points.");
								client.getPointsHandler().incrementSkillPoints(10);
								client.getPacketSender()
							...
							if (theTrap.getGameObject().getId() == 19191) {
								...
								client.getPacketSender().sendMessage(
									...
									if(chance >= 30) {
										client.getInventory().add(10835, 1000);
										client.getPointsHandler().setSkillPoints(500, true);
	...
	public static void lootTrap(Player player, GameObject gameObject) {
