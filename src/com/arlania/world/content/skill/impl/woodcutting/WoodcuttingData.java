...
public class WoodcuttingData {
	...
	public static enum Trees {
		...
		UNDEAD_TREE(95, 2000, 744, new int[] { 8416 }, 35, true),
		CUSTOM_TREE(99, 20000, 7629, new int[] { 10660 }, 35, true),
        RAIDS_TREE(90, 20000, 3438, new int[] {8417  }, 35, true);
