...
public class BossPets {
	...
	public enum BossPet {
		...
		MEW(-1, 12299, 16509),
		YUGI_MUTO(-1, 10004, 3891),
		

		FOUNDERS_PET(-1, 1252, 1867), 
		GOKU(100, 806, 5127), 
		ELON_MUSK(-1, 304, 2595), 	
		BLOOD_GENIE(-1, 12826, 14924),
		
		LUGIA(-1, 12807, 14035), 
		VEGETA(101, 808, 5128),
		FUZEDG(527, 809, 5135), 
		DARK_CHARIZARD(-1, 12822, 18411), 
		SKOTIZO(7286, 1946, 5148), 
		GEORGIE(-1, 4545, 14980),
		JACKOLANTERN(-1, 4546, 14987),
		KRUGER(-1, 4250, 14993),
		MYERS(-1, 4251, 14999),
		JASON(-1, 4252, 15007),
		SLENDER_MAN(-1, 3920, 15011),
		EEVEE(-1, 3137, 4742),
		JOLTEON(-1, 3138, 4743),
		FLAREON(-1, 642, 4744),
		VAPEREON(-1, 644, 4786),
		...
		JOKER(420, 640, 5161), 
		SHENRON(-1, 12213, 7034), 
		L33TDRAGON(-1, 12240, 14555),
		Pwnlite_PET(-1, 160, 7014),
		CHARIZARD(2843, 641, 5162), 
		YOSHI(8548, 12812, 18412),
		AKUNA(11808, 11811, 18413),
