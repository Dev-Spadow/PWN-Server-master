...
public class FrozenChest {
	
	/*
	 * Rewards
	 */
	public static final int [] shitRewards = {1};
	public static final int [] goodRewards = {1 };
	public static final int [] bestRewards = {1 };
	...
	public static void open (Player player) {
		...
		player.getInventory().delete(13198, 1);
