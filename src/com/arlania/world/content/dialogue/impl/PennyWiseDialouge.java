...
public class PennyWiseDialouge {
	...
	public static Dialogue getDialogue(Player player, int stage) {
		...
		case 0:
			dialogue = new Dialogue() {
				...
				public String[] dialogue() {
					return new String[] { "Interact with Pennywise", "Enter the Sewer", "Offer Halloween Tickets", "Exit"};
				}
				
				@Override
				public void specialAction() {
					player.setDialogueActionId(2506);
				}
			};
			break;
		case 1: // selecting raid
			dialogue = new Dialogue() {
				...
				@Override
				public String[] dialogue() {
					return new String[] { "@red@Do you want to play a game? you'll float too!" };
				}
				@Override
				public void specialAction() {
