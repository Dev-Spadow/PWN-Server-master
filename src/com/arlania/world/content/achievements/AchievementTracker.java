...
public class AchievementTracker {
    ...
    public void progress(AchievementData achievement, int amount) {
        ...
        if (oldProgress != newProgress && newProgress >= achievement.progressAmount) {
            player.sendMessage("<img=31> <shad=e77700>You have completed the achievement</shad>: " + achievement.toString() + ".");
            player.sendMessage("@red@Dont forget to claim your reward");
            QuestTab.updateCharacterSummaryTab(player, QuestTab.UpdateData.ACHIEVEMENTS);
        }
    }
