...
public class RajinStrategy implements CombatStrategy {
    @Override
    ...
    public boolean customContainerAttack(Character entity, Character victim) {
        ...
        if (n > 85) {
            player.performGraphic(new Graphic(74, GraphicHeight.LOW));
            CombatFactory.poisonEntity(player, CombatPoisonEffect.PoisonType.SUPER);
            System.out.println("@red@Been poisoned");
        } else if (n > 55) {
