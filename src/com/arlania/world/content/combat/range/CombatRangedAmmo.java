...
public class CombatRangedAmmo {
	...
	public enum RangedWeaponData {
		...
		MAGIC_SHORTBOW(new int[] {4312, 3666, 3072, 3069, 3077,3663, 3074, 18965, 5171,3971,5249,861, 6724}, new AmmunitionData[] {AmmunitionData.HAND_CANNON_SHOT, AmmunitionData.IRON_ARROW, AmmunitionData.STEEL_ARROW, AmmunitionData.MITHRIL_ARROW, AmmunitionData.ADAMANT_ARROW, AmmunitionData.RUNE_ARROW, AmmunitionData.ICE_ARROW, AmmunitionData.BROAD_ARROW}, RangedWeaponType.SHORTBOW),
		GODBOW(new int[] {19143, 19149, 19146}, new AmmunitionData[] {AmmunitionData.BRONZE_ARROW, AmmunitionData.IRON_ARROW, AmmunitionData.HAND_CANNON_SHOT, AmmunitionData.MITHRIL_ARROW, AmmunitionData.ADAMANT_ARROW, AmmunitionData.RUNE_ARROW, AmmunitionData.BROAD_ARROW, AmmunitionData.DRAGON_ARROW}, RangedWeaponType.SHORTBOW),
		...
		DARK_BOW(new int[] { 3084, 3083, 11235, 13405, 18971, 15701, 15702, 15703, 15704, 19957}, new AmmunitionData[] {AmmunitionData.BRONZE_ARROW, AmmunitionData.IRON_ARROW, AmmunitionData.STEEL_ARROW, AmmunitionData.MITHRIL_ARROW, AmmunitionData.ADAMANT_ARROW, AmmunitionData.HAND_CANNON_SHOT, AmmunitionData.DRAGON_ARROW}, RangedWeaponType.DARK_BOW),
		...
		DRAGON_DART(new int[] {11230,10479}, new AmmunitionData[] {AmmunitionData.DRAGON_DART}, RangedWeaponType.THROW),
		...
		STARTERBOW(new int[] {9492,8655,18912,13201}, new AmmunitionData[] {AmmunitionData.HAND_CANNON_SHOT}, RangedWeaponType.SHORTBOW),
		JOKERS_BOW(new int[] {3082}, new AmmunitionData[] {AmmunitionData.HAND_CANNON_SHOT}, RangedWeaponType.SHORTBOW),
		HAND_CANNON(new int[] {5133, 5081, 5132, 5134, 5131, 5195,10905,17849,16540,20427,8488,14921,16523,16525,16526,16528,14028,16436,16476,3290,7764,80,5158, 3987,3275, 3991,5115,15010, 3990, 896, 5130, 15241, 5125}, new AmmunitionData[] {AmmunitionData.HAND_CANNON_SHOT}, RangedWeaponType.HAND_CANNON),
	...
	public enum AmmunitionData {
		...
		DRAGONBLOWPIPE(new int[] {20557}, -1, 1123, 10, 20, 85, 23, 25),
		...
		DRAGON_DART(new int[] {11230,10479}, 1123, 226, 3, 33, 25, 45, 37),
		...
		HAND_CANNON_SHOT(new int[] {15243}, 2138, 2143, 3, 8, 45, 43, 31),
		UMD_SHOT(new int[] {8857}, 2138, 2989, 3, 8, 115, 43, 31),
		SARADOMIN_ARROW(new int[] {19152}, 472, 473, 3, 44, 66, 43, 31),
		ARMADYLIAN_ARROW(new int[] {9706}, -1, 374, 3, 44, 103, 43, 31),
		NO_AMMO(new int[] {-1}, 2138, 2143, 2, 40, 7, 45, 37),
