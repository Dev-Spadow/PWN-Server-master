...
public class DwarfMultiCannon {
	...
	public static void attack(Player player) { //TODO: Bad hardcoding of setting damage, switch to combathittask 
        ...
        player.getAchievementTracker().progress(com.arlania.world.content.achievements.AchievementData.DEAL_EASY_DAMAGE_USING_RANGED, dmg.getDamage());
        player.getAchievementTracker().progress(com.arlania.world.content.achievements.AchievementData.DEAL_MEDIUM_DAMAGE_USING_RANGED, dmg.getDamage());
        player.getAchievementTracker().progress(com.arlania.world.content.achievements.AchievementData.DEAL_HARD_DAMAGE_USING_RANGED, dmg.getDamage());
