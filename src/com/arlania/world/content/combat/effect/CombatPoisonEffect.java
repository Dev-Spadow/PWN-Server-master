...
public class CombatPoisonEffect extends Task {
    ...
    public void execute() {
        ...
        entity.dealDamage(new Hit(entity.getAndDecrementPoisonDamage(), Hitmask.LIGHT_YELLOW, CombatIcon.NONE));
       /* if(entity.isPlayer()) {
    ...
    public static final class CombatPoisonData {
        ...
        public static void init() {
        	...
        	types.put(2767, PoisonType.BLOWPIPE);
            ...
            types.put(17849, PoisonType.MILD);
            ...
            types.put(16540, PoisonType.MILD);
