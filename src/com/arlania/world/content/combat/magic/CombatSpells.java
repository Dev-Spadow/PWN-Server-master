...
public enum CombatSpells {
	...
	RED_SCEPTRE(new CombatAncientSpell() {
		@Override
		public void spellEffect(Character cast, Character castOn, int damage) {
			if (damage < 1) {
				return;
	...
	BLUE_ARSENIC(new CombatNormalSpell() {
		@Override
		public Optional<Animation> castAnimation() {
			return Optional.of(new Animation(811));
		}
		...
		@Override
		public Optional<Projectile> castProjectile(Character cast, Character castOn) {
			return Optional.of(new Projectile(cast, castOn, 1052, 44, 3, 23, 31, 0));
		}

		@Override
		public Optional<Graphic> endGraphic() {
			return Optional.of(new Graphic(1052, GraphicHeight.MIDDLE));
		}
	...
	PUMPKIN_STRIKE(new CombatNormalSpell() {
		@Override
		public Optional<Animation> castAnimation() {
			return Optional.of(new Animation(14221));
		}
		...
		@Override
		public Optional<Projectile> castProjectile(Character cast, Character castOn) {
			return Optional.of(new Projectile(cast, castOn, 1055, 44, 3, 43, 31,
					0));
		}

		@Override
		public Optional<Graphic> endGraphic() {
			return Optional.of(new Graphic(1056, GraphicHeight.LOW));
		}
	...
	RED_VIRUS(new CombatAncientSpell() {
		@Override
		public void spellEffect(Character cast, Character castOn, int damage) {
			if (damage < 1) {
				return;
	...
	BLUE_VIRUS(new CombatAncientSpell() {
		@Override
		public void spellEffect(Character cast, Character castOn, int damage) {
			if (damage < 1) {
				return;
		...
		@Override
		public Optional<Graphic> endGraphic() {
			return Optional.of(new Graphic(1054));
		}
	...
	RED_VIRUS1(new CombatAncientSpell() {
		@Override
		public void spellEffect(Character cast, Character castOn, int damage) {
			if (damage < 1) {
				return;
	...
	OBITO(new CombatAncientSpell() {
		@Override
		public void spellEffect(Character cast, Character castOn, int damage) {
			if (damage < 1) {
				return;
			}
		//	cast.heal((int) (damage * 0.05));
		}
		...
		@Override
		public Optional<Graphic> endGraphic() {
			return Optional.of(new Graphic(989));
		}
	...
	SEISMIC1(new CombatNormalSpell() {
		@Override
		public Optional<Animation> castAnimation() {
			return Optional.of(new Animation(1978));
		}
	...
	FROZEN_STAFFII(new CombatNormalSpell() {
		@Override
		public Optional<Animation> castAnimation() {
			return Optional.of(new Animation(811));
		}
		...
		@Override
		public Optional<Projectile> castProjectile(Character cast, Character castOn) {
			return Optional.of(new Projectile(cast, castOn, 5, 44, 3, 25, 13, 0));//976
		}
	...
	FROZEN_STAFFIII(new CombatNormalSpell() {
		@Override
		public Optional<Animation> castAnimation() {
			return Optional.of(new Animation(811));
		}
	...
	APOLLYONSTAFF(new CombatNormalSpell() {
		@Override
		public Optional<Animation> castAnimation() {
			return Optional.of(new Animation(811));
		}
		...
		@Override
		public Optional<Projectile> castProjectile(Character cast, Character castOn) {
			return Optional.of(new Projectile(cast, castOn, 4, 44, 3, 25, 13, 0));//976
		}
	...
	MARTY2(new CombatAncientSpell() {
		...
		@Override
		public Optional<Projectile> castProjectile(Character cast, Character castOn) {
			return Optional.of(new Projectile(cast, castOn, 7, 44, 3, 25, 13, 0));//976
		}
	...
	MARTY1(new CombatAncientSpell() {
		...
		@Override
		public Optional<Projectile> castProjectile(Character cast, Character castOn) {
			return Optional.of(new Projectile(cast, castOn, 435, 44, 3, 25, 13, 0));//976
		}
	...
	CUNTSTAFF(new CombatAncientSpell() {
		@Override
		public void spellEffect(Character cast, Character castOn, int damage) {
			if (damage < 1) {
				return;
		...
		@Override
		public Optional<Projectile> castProjectile(Character cast, Character castOn) {
			return Optional.of(new Projectile(cast, castOn, 3008, 44, 3, 25, 13, 0));//976
		}
	...
	SCYTHESTAFF(new CombatAncientSpell() {
		@Override
		public void spellEffect(Character cast, Character castOn, int damage) {
			if (damage < 1) {
				return;
		...
		@Override
		public Optional<Projectile> castProjectile(Character cast, Character castOn) {
			return Optional.of(new Projectile(cast, castOn, 76 , 44, 3, 25, 13, 0));//976
		}
	...
	EMERALDSSTAFF(new CombatAncientSpell() {
		@Override
		public void spellEffect(Character cast, Character castOn, int damage) {
			if (damage < 1) {
				return;
	...
	PLAYER_ONE(new CombatAncientSpell() {
		@Override
		public void spellEffect(Character cast, Character castOn, int damage) {
			if (damage < 1) {
				return;
			}
			cast.heal((int) (damage * 0.33));
		}
		...
		@Override
		public Optional<Projectile> castProjectile(Character cast, Character castOn) {
			return Optional.of(new Projectile(cast, castOn, 2256, 44, 3, 43, 31, 0));//976 old 4230 new
		}
	...
	LLUS(new CombatAncientSpell() {
		...
		@Override
		public Optional<Projectile> castProjectile(Character cast, Character castOn) {
			return Optional.of(new Projectile(cast, castOn, 976, 44, 3, 43, 31, 0));//976 old 4230 new
		}
	...
	SUZUMIANSTAFF(new CombatAncientSpell() {
		@Override
		public void spellEffect(Character cast, Character castOn, int damage) {
			if (damage < 1) {
				return;
		...
		@Override
		public Optional<Projectile> castProjectile(Character cast, Character castOn) {
			return Optional.of(new Projectile(cast, castOn, 3001, 44, 3, 25, 13, 0));//976 3005 3007 3003
		}
	...
	LORIENSTAFF(new CombatAncientSpell() {
		@Override
		public void spellEffect(Character cast, Character castOn, int damage) {
			if (damage < 1) {
				return;
		...
		@Override
		public Optional<Projectile> castProjectile(Character cast, Character castOn) {
			return Optional.of(new Projectile(cast, castOn, 2248, 44, 3, 25, 13, 0));//976 3005 3007 3003 2723
		}
	...
	SAUSAGESTAFF(new CombatAncientSpell() {
		@Override
		public void spellEffect(Character cast, Character castOn, int damage) {
			if (damage < 1) {
				return;
		...
		@Override
		public Optional<Projectile> castProjectile(Character cast, Character castOn) {
			return Optional.of(new Projectile(cast, castOn, 2283, 44, 3, 25, 13, 0));//976
		}
	...
	DAFACKSTAFF(new CombatAncientSpell() {
		@Override
		public void spellEffect(Character cast, Character castOn, int damage) {
			if (damage < 1) {
				return;
		...
		@Override
		public Optional<Projectile> castProjectile(Character cast, Character castOn) {
			return Optional.of(new Projectile(cast, castOn, 6, 44, 3, 25, 13, 0));//976
		}
	...
	TAIGA(new CombatAncientSpell() {
		...
		@Override
		public Optional<Animation> castAnimation() {
			return Optional.of(new Animation(426));
		}
		
		
		@Override
		public Optional<Projectile> castProjectile(Character cast, Character castOn) {
			return Optional.of(new Projectile(cast, castOn, 1099, 44, 3, 43, 31, 0));//976
		}
	...
	AVEDA(new CombatAncientSpell() {
		...
		@Override
		public Optional<Animation> castAnimation() {
			return Optional.of(new Animation(0622));
		}
		
		
		@Override
		public Optional<Projectile> castProjectile(Character cast, Character castOn) {
			return Optional.of(new Projectile(cast, castOn, 2699, 44, 3, 43, 31, 0));//976 //2266
		}
	...
	FROZEN_STAFF(new CombatNormalSpell() {
		@Override
		public Optional<Animation> castAnimation() {
			return Optional.of(new Animation(811));
		}
	...
	STAFFOFGRACE(new CombatNormalSpell() {
		@Override
		public Optional<Animation> castAnimation() {
			return Optional.of(new Animation(811));
		}
		...
		@Override
		public Optional<Projectile> castProjectile(Character cast, Character castOn) {
			return Optional.of(new Projectile(cast, castOn, 1006, 44, 3, 25, 13, 0));//976
		}
	...
	AZAZEL(new CombatNormalSpell() {
		...
		@Override
		public Optional<Projectile> castProjectile(Character cast, Character castOn) {
			return Optional.of(new Projectile(cast, castOn, 985, 44, 3, 42, 31, 0));//976
		}
	...
	AKASHA(new CombatNormalSpell() {
		...
		@Override
		public Optional<Projectile> castProjectile(Character cast, Character castOn) {
			return Optional.of(new Projectile(cast, castOn, 380, 44, 3, 42, 31, 0));//976
		}
	...
	ARCTIC(new CombatNormalSpell() {
		...
		@Override
		public Optional<Projectile> castProjectile(Character cast, Character castOn) {
			return Optional.of(new Projectile(cast, castOn, 2122, 44, 3, 42, 31, 0));//976
		}
	...
	STAFFOFLUST(new CombatAncientSpell() {
		@Override
		public void spellEffect(Character cast, Character castOn, int damage) {
			if (damage < 1) {
				return;
	...
	//		cast.heal((int) (damage * 0.10));
		...
		@Override
		public Optional<Projectile> castProjectile(Character cast, Character castOn) {
			return Optional.of(new Projectile(cast, castOn, 1053, 44, 3, 25, 13, 0));//976
		}
	...
	DEATHBLUE(new CombatNormalSpell() {
		@Override
		public Optional<Animation> castAnimation() {
			return Optional.of(new Animation(1978));
		}
		...
		@Override
		public Optional<Projectile> castProjectile(Character cast, Character castOn) {
			return Optional.of(new Projectile(cast, castOn, 976, 44, 3, 43, 31, 0));
		}
