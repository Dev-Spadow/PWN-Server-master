...
public enum CombatSpecial {
    ...
    STARTER_WHIP(new int[]{3081}, 50, 1, 1, CombatType.MELEE, WeaponInterface.WHIP) {
			  ...
			  ZARYTE(new int[]{4706, 18971,9492}, 50, 0.03, 0.10, CombatType.RANGED, WeaponInterface.SHORTBOW) {
                @Override
                public CombatContainer container(Player player, Character target) {
			  ...
			  DECENTMGS(new int[]{3990, 5131, 5195,10905, 5158, 3987, 5134, 5133, 5081, 5132, 5125}, 100, 4.3, 4.3, CombatType.RANGED, WeaponInterface.SHORTBOW) {
                ...
                public CombatContainer container(Player player, Character target) {
      			  ...
      			  BFG(new int[]{20427,14921,14028,16436,16476,3290,7764,80}, 100, 4.3, 4.3, CombatType.RANGED, WeaponInterface.SHORTBOW) {
                      @Override
                      public CombatContainer container(Player player, Character target) {
                          player.performAnimation(new Animation(12153));
    ...
    SARADOMIN_SWORD(new int[]{11730, 19028,5175}, 100, 1.35, 1.2, CombatType.MELEE, WeaponInterface.TWO_HANDED_SWORD) {
                @Override
                public CombatContainer container(Player player, Character target) {
    ...
    CELESTIAL_WARHAMMER(new int[]{5175}, 25, 1.35, 1.2, CombatType.MELEE, WeaponInterface.WARHAMMER) {
                @Override
                public CombatContainer container(Player player, Character target) {
    ...
    DRAGON1_BLOWPIPE(new int[] { 2767 }, 50, 1.45, 2.35, CombatType.RANGED, WeaponInterface.DART) {
        		@Override
        		public CombatContainer container(Player player, Character target) {
        			player.performAnimation(new Animation(5061));
        			player.performGraphic(new Graphic(1123));
    ...
    DRAGON_BATTLEAXE(new int[]{3651}, 100, 1, 1, CombatType.MELEE, WeaponInterface.BATTLEAXE) {
                @Override
