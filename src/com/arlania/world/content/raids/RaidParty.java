...
public class RaidParty {
	...
	public RaidParty(Player raidLeader) {
		...
		raidLeader.sendMessage("->@blu@<shad=10>You can invite a maximum of 3 players to your raid party.");
	}
	...
	public void addMember(Player recruit) {
		...
		if (raidMembers.size() >= 3) {
			raidLeader.sendMessage("@red@<shad=200>You can only add 3 additional players to your raid party.");
			return;
		}
