...
import com.arlania.world.entity.impl.player.Player;
	...
	/** Evil Tree's Spawning every 2 hours **/
...
public class EvilTrees {
	...
	private static final int TIME = 12000; //2 hours? not sure lol
	
	public static final int MAX_CUT_AMOUNT = 3000;//Amount of logs the tree will give before
											//despawning
	...
	public static enum LocationData {
		...
		LOCATION_1(new Position(3124, 3244), "", "@or1@(::afk)");
	...
	public static void sequence() {
		if (SPAWNED_TREE == null) {
			if (timer.elapsed(TIME)) {
				...
				World.sendMessage("<img=10> <shad=1>@gre@[AFK TREE]:</shad>@bla@ The Evil Tree has Appeared " + locationData.clue + "");
				timer.reset();
			}
		} else {
