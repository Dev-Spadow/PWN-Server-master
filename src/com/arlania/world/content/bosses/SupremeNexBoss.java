...
public class SupremeNexBoss extends NPC {

	public static int[] COMMONLOOT = {1573,6199,989,10835,3988,3912};
	public static int[] SUPERRARELOOT = {6507,2545,2546,2547,5184,4670,4671,4672,4673};
	public static int[] EXTREMELOOT = {19727,19728,19729,19730,19731,19732,6485,15374,19935};
	/**
	 * 
	 */
	public static final int NPC_ID = 169;
	 ...
	 * 
	 */
	private static SupremeNexBoss current;

	/**
	 * 
	 * @param position
	 */
	public SupremeNexBoss(Position position) {
	 ...
	 * @return
	 */
	public static SupremeNexBoss getCurrent() {
		return current;
	}
	 ...
	 * @param current
	 */
	public static void setCurrent(SupremeNexBoss current) {
		SupremeNexBoss.current = current;
	}
	 ...
	 *
	 */
	public static class CloudBossLocation extends Position {
		 ...
		 * @param location
		 */
		public CloudBossLocation(int x, int y, int z, String location) {
			super(x, y, z);
