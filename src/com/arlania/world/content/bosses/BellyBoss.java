...
public class BellyBoss extends NPC {

	public static int[] COMMONLOOT = {10835};
	public static int[] RARELOOT = { 6504};
	/**
	 * 
	 */
	 ...
	 */
	public static final BellyBossLocation[] LOCATIONS = { new BellyBossLocation(3476, 3093, 0, "") };

	/**
	 * 
	 */
	private static BellyBoss current;

	/**
	 * 
	 * @param position
	 */
	public BellyBoss(Position position) {
	...
	public static void spawn() {
		...
		BellyBossLocation location = Misc.randomElement(LOCATIONS);
		BellyBoss instance = new BellyBoss(location.copy());
	 ...
	 * @return
	 */
	public static BellyBoss getCurrent() {
		return current;
	}
	 ...
	 * @param current
	 */
	public static void setCurrent(BellyBoss current) {
		BellyBoss.current = current;
	}
	 ...
	 *
	 */
	public static class BellyBossLocation extends Position {
		 ...
		 * @param location
		 */
		public BellyBossLocation(int x, int y, int z, String location) {
			super(x, y, z);
