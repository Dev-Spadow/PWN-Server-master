...
public class KbdBoss extends NPC {

	public static int[] COMMONLOOT = {10835,989,1543,6532,744,15373};
	public static int[] UNCOMMONLOOT = {19935,19936,19106,1464,6199};
	public static int[] RARELOOT = { 3810,3811,3812,3813,3814,3815,4780};
	/**
	 * 
	 */
	public static final int NPC_ID = 50;

	/**
	 * add your maps to that folder open me your client.java in client
	 */
	public static final KbdBossLocation[] LOCATIONS = { new KbdBossLocation(3476, 3093, 0, "") };

	/**
	 * 
	 */
	private static KbdBoss current;

	/**
	 * 
	 * @param position
	 */
	public KbdBoss(Position position) {
	...
	public static void spawn() {
		...
		KbdBossLocation location = Misc.randomElement(LOCATIONS);
		KbdBoss instance = new KbdBoss(location.copy());
	 ...
	 * @return
	 */
	public static KbdBoss getCurrent() {
		return current;
	}
	 ...
	 * @param current
	 */
	public static void setCurrent(KbdBoss current) {
		KbdBoss.current = current;
	}
	 ...
	 *
	 */
	public static class KbdBossLocation extends Position {
		 ...
		 * @param location
		 */
		public KbdBossLocation(int x, int y, int z, String location) {
			super(x, y, z);
