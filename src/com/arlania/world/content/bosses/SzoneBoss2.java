...
public class SzoneBoss2 extends NPC {

	public static int[] COMMONLOOT = {989,1543,1464};
	public static int[] RARELOOT = { 6507,19886,298,6199,3912};
	public static int[] SUPERRARELOOT = {6640};
	public static int[] LUCKYLOOT = {9943};
	public static int[] EXTREMELOOT = {6191,6192};
	/**
	 * 
	 */
	public static final int NPC_ID = 9286;

	/**
	 * add your maps to that folder open me your client.java in client
	 */
	public static final SzoneBoss2Location[] LOCATIONS = { new SzoneBoss2Location(2861, 3200, 0, "") };

	/**
	 * 
	 */
	private static SzoneBoss2 current;

	/**
	 * 
	 * @param position
	 */
	public SzoneBoss2(Position position) {
	...
	public static void spawn() {
		...
		SzoneBoss2Location location = Misc.randomElement(LOCATIONS);
		SzoneBoss2 instance = new SzoneBoss2(location.copy());
	 ...
	 * @return
	 */
	public static SzoneBoss2 getCurrent() {
		return current;
	}
	 ...
	 * @param current
	 */
	public static void setCurrent(SzoneBoss2 current) {
		SzoneBoss2.current = current;
	}
	 ...
	 *
	 */
	public static class SzoneBoss2Location extends Position {
		 ...
		 * @param location
		 */
		public SzoneBoss2Location(int x, int y, int z, String location) {
			super(x, y, z);
