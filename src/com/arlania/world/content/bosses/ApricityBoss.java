...
public class ApricityBoss extends NPC {

	public static int[] COMMONLOOT = {10835,15374,3912,989,1543};
	public static int[] EXTREMELOOT = {18419,18420,18421};
	/**
	 * 
	 */
	public static final int NPC_ID = 12101;

	/**
	 * add your maps to that folder open me your client.java in client
	 */
	public static final ApricityBossLocation[] LOCATIONS = { new ApricityBossLocation(2772, 3745, 4, "") };

	/**
	 * 
	 */
	private static ApricityBoss current;

	/**
	 * 
	 * @param position
	 */
	public ApricityBoss(Position position) {
	...
	public static void spawn() {
		...
		ApricityBossLocation location = Misc.randomElement(LOCATIONS);
		ApricityBoss instance = new ApricityBoss(location.copy());
	...
	public static void giveLoot(Player player, NPC npc, Position pos) {
		...
		if (chance >= 249) {
			...
			World.sendMessage(
					"<col=fcfcfc><shad=dd8a14><img=418>[Apricity Boss]</shad>@bla@: " + player.getUsername() + " received@mag@<shad=9f199d> " + itemMessage + "</shad>@bla@ from Apricity");
					return;
		}
	 ...
	 * @return
	 */
	public static ApricityBoss getCurrent() {
		return current;
	}
	 ...
	 * @param current
	 */
	public static void setCurrent(ApricityBoss current) {
		ApricityBoss.current = current;
	}
	 ...
	 *
	 */
	public static class ApricityBossLocation extends Position {
		 ...
		 * @param location
		 */
		public ApricityBossLocation(int x, int y, int z, String location) {
			super(x, y, z);
