...
public class ZeusBoss extends NPC {

	public static int[] COMMONLOOT = {10835,13256,13258,13259};
	public static int[] RARELOOT = { 989,15373,19137,19138,19139};
	public static int[] SUPERRARELOOT = {19131,19132,19133,18940,18941,18942};
	public static int[] EXTREMELOOT = {19721,19722,19723,19724,19725,19734,19736,1464};
	/**
	 * 
	 */
	public static final int NPC_ID = 15;

	/**
	 * add your maps to that folder open me your client.java in client
	 */
	public static final ZeusBossLocation[] LOCATIONS = { new ZeusBossLocation(2076, 3672, 0, "") };

	/**
	 * 
	 */
	private static ZeusBoss current;

	/**
	 * 
	 * @param position
	 */
	public ZeusBoss(Position position) {
	...
	public static void spawn() {
		...
		ZeusBossLocation location = Misc.randomElement(LOCATIONS);
		ZeusBoss instance = new ZeusBoss(location.copy());
	...
	public static void giveLoot(Player player, NPC npc, Position pos) {
		...
		GroundItemManager.spawnGroundItem(player,
				new GroundItem(new Item(10835, 75), pos, player.getUsername(), false, 150, true, 200));
		
		if (chance >= 149) {
			player.getAchievementTracker().progress(com.arlania.world.content.achievements.AchievementData.KILL_ZEUS_50_TIMES, 1);
			player.getAchievementTracker().progress(com.arlania.world.content.achievements.AchievementData.KILL_ZEUS_250_TIMES, 1);
			GroundItemManager.spawnGroundItem(player,
	 ...
	 * @return
	 */
	public static ZeusBoss getCurrent() {
		return current;
	}
	 ...
	 * @param current
	 */
	public static void setCurrent(ZeusBoss current) {
		ZeusBoss.current = current;
	}
	 ...
	 *
	 */
	public static class ZeusBossLocation extends Position {
		 ...
		 * @param location
		 */
		public ZeusBossLocation(int x, int y, int z, String location) {
			super(x, y, z);
