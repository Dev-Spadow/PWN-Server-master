...
public class AsunaBoss extends NPC {
	 ...
	 * 
	 */
	public static final int NPC_ID = 12823;

	/**
	 * add your maps to that folder open me your client.java in client
	 */
	public static final AsunaBossLocation[] LOCATIONS = { new AsunaBossLocation(3476, 3093, 0, "") };

	/**
	 * 
	 */
	private static AsunaBoss current;

	/**
	 * 
	 * @param position
	 */
	public AsunaBoss(Position position) {
	...
	public static void spawn() {
		...
		AsunaBossLocation location = Misc.randomElement(LOCATIONS);
		AsunaBoss instance = new AsunaBoss(location.copy());
	...
	public static void giveLoot(Player player, NPC npc, Position pos) {
		...
		GroundItemManager.spawnGroundItem(player,
				new GroundItem(new Item(10835, 150), pos, player.getUsername(), false, 150, true, 200));
		if (chance >= 149) {
			GroundItemManager.spawnGroundItem(player,
	 ...
	 * @return
	 */
	public static AsunaBoss getCurrent() {
		return current;
	}
	 ...
	 * @param current
	 */
	public static void setCurrent(AsunaBoss current) {
		AsunaBoss.current = current;
	}
	 ...
	 *
	 */
	public static class AsunaBossLocation extends Position {
		 ...
		 * @param location
		 */
		public AsunaBossLocation(int x, int y, int z, String location) {
			super(x, y, z);
