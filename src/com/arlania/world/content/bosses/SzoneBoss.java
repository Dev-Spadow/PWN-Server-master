...
public class SzoneBoss extends NPC {
	 ...
	 * 
	 */
	public static final int NPC_ID = 11361;

	/**
	 * add your maps to that folder open me your client.java in client
	 */
	public static final SzoneBossLocation[] LOCATIONS = { new SzoneBossLocation(2826, 3196, 0, "") };

	/**
	 * 
	 */
	private static SzoneBoss current;

	/**
	 * 
	 * @param position
	 */
	public SzoneBoss(Position position) {
	...
	public static void spawn() {
		...
		SzoneBossLocation location = Misc.randomElement(LOCATIONS);
		SzoneBoss instance = new SzoneBoss(location.copy());
	 ...
	 * @return
	 */
	public static SzoneBoss getCurrent() {
		return current;
	}
	 ...
	 * @param current
	 */
	public static void setCurrent(SzoneBoss current) {
		SzoneBoss.current = current;
	}
	 ...
	 *
	 */
	public static class SzoneBossLocation extends Position {
		 ...
		 * @param location
		 */
		public SzoneBossLocation(int x, int y, int z, String location) {
			super(x, y, z);
