...
public class VetionBoss extends NPC {
	 ...
	 */
	public static final VetionBossLocation[] LOCATIONS = { new VetionBossLocation(3476, 3093, 0, "") };

	/**
	 * 
	 */
	private static VetionBoss current;

	/**
	 * 
	 * @param position
	 */
	public VetionBoss(Position position) {
	...
	public static void spawn() {
		...
		VetionBossLocation location = Misc.randomElement(LOCATIONS);
		VetionBoss instance = new VetionBoss(location.copy());
	 ...
	 * @return
	 */
	public static VetionBoss getCurrent() {
		return current;
	}
	 ...
	 * @param current
	 */
	public static void setCurrent(VetionBoss current) {
		VetionBoss.current = current;
	}
	 ...
	 *
	 */
	public static class VetionBossLocation extends Position {
		 ...
		 * @param location
		 */
		public VetionBossLocation(int x, int y, int z, String location) {
			super(x, y, z);
