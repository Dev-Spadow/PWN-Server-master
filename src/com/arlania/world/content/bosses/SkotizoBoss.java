...
public class SkotizoBoss extends NPC {
	 ...
	 */
	public static final SkotizoBossLocation[] LOCATIONS = { new SkotizoBossLocation(3476, 3093, 0, "") };

	/**
	 * 
	 */
	private static SkotizoBoss current;

	/**
	 * 
	 * @param position
	 */
	public SkotizoBoss(Position position) {
	...
	public static void spawn() {
		...
		SkotizoBossLocation location = Misc.randomElement(LOCATIONS);
		SkotizoBoss instance = new SkotizoBoss(location.copy());
	 ...
	 * @return
	 */
	public static SkotizoBoss getCurrent() {
		return current;
	}
	 ...
	 * @param current
	 */
	public static void setCurrent(SkotizoBoss current) {
		SkotizoBoss.current = current;
	}
	 ...
	 *
	 */
	public static class SkotizoBossLocation extends Position {
		 ...
		 * @param location
		 */
		public SkotizoBossLocation(int x, int y, int z, String location) {
			super(x, y, z);
