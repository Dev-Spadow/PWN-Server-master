...
public class RajinBoss extends NPC {
	...
	public static int[] COMMONLOOT = {15373,1499,3951,3973,4799,4800,4801,1543,19935,4670,4671,4672,4673,6507,6193,6194,6195,6196,6197,6198,3980,3999,4000,4001,18955,
			18956,18957,4761,4762,4763,4764,4765,5089,926,5210,931,5211,930,15045,3064,
			19159,19160,19161,19163,19164,19165,19166,2760};
	...
	public static int[] EXTREMELOOT = {16524,10168};
	/**
	 * 
	 */
	public static final int NPC_ID = 12836;

	/**
	 * add your maps to that folder open me your client.java in client
	 */
	public static final RajinBossLocation[] LOCATIONS = { new RajinBossLocation(2914, 4452, 0, "") };

	/**
	 * 
	 */
	private static RajinBoss current;

	/**
	 * 
	 * @param position
	 */
	public RajinBoss(Position position) {
	...
	public static void spawn() {
		...
		RajinBossLocation location = Misc.randomElement(LOCATIONS);
		RajinBoss instance = new RajinBoss(location.copy());
	...
	public static void giveLoot(Player player, NPC npc, Position pos) {
		...
		player.getInventory().add(17750, Misc.inclusiveRandom(1, 20));
		...
		if (chance >= 2498) {
			...
			World.sendMessage(
					"<col=fcfcfc><shad=dd8a14><img=418>[Rajin Boss]</shad>@bla@: " + player.getUsername() + " received@yel@<shad=f4e019> " + itemMessage + "</shad>@bla@from Rajin");
					return;
		}
		...
		if (chance >= 2490) {
			...
			String itemMessage = Misc.anOrA(itemName) + " " + itemName;
			World.sendMessage(
					"<col=fcfcfc><shad=dd8a14><img=418>[Rajin Boss]</shad>@bla@: " + player.getUsername() + " received@mag@<shad=9f199d> " + itemMessage + "</shad>@bla@ from Rajin");
					return;
		}
	 ...
	 * @return
	 */
	public static RajinBoss getCurrent() {
		return current;
	}
	 ...
	 * @param current
	 */
	public static void setCurrent(RajinBoss current) {
		RajinBoss.current = current;
	}
	 ...
	 *
	 */
	public static class RajinBossLocation extends Position {
		 ...
		 * @param location
		 */
		public RajinBossLocation(int x, int y, int z, String location) {
			super(x, y, z);
