...
public class Dueling {
	...
	public void challengePlayer(Player playerToDuel) {
		...
		if(player.getGameMode() == GameMode.GROUP_IRONMAN) {
			player.getPacketSender().sendMessage("You are an Iron Man. You stand alone.");
			return;
		}
 
		if(playerToDuel.getGameMode() == GameMode.GROUP_IRONMAN) {
			player.getPacketSender().sendMessage(playerToDuel.getUsername() + " is an Iron Man. He stands alone.");
			return;
		}
