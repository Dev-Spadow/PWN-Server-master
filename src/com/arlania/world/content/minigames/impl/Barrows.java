...
public class Barrows {
	...
	public static boolean handleObject(final Player player, GameObject object) {
		switch(object.getId()) {
		case 567:
			searchCoffin(player, object.getId(), 4, 2026, object.getPosition() != null ? new Position(3551, 9693, player.getPosition().getZ()) : new Position(3552, 9693));
			return true;
		case 562:
			searchCoffin(player, object.getId(), 0, 2030, object.getPosition() != null ? new Position(3551, 9693, player.getPosition().getZ()) : new Position(3552, 9693));
			return true;
		case 563:
			searchCoffin(player, object.getId(), 5, 2025, object.getPosition() != null ? new Position(3551, 9693, player.getPosition().getZ()) : new Position(3552, 9693));
			return true;
		case 564:
			searchCoffin(player, object.getId(), 1, 2029, object.getPosition() != null ? new Position(3551, 9693, player.getPosition().getZ()) : new Position(3552, 9693));
			return true;
		case 565:
			searchCoffin(player, object.getId(), 2, 2028, object.getPosition() != null ? new Position(3551, 9693, player.getPosition().getZ()) : new Position(3552, 9693));
			return true;
		case 6773:
			searchCoffin(player, object.getId(), 3, 2027, object.getPosition() != null ? new Position(3551, 9693, player.getPosition().getZ()) : new Position(3552, 9693));
			return true;
		case 6745:
