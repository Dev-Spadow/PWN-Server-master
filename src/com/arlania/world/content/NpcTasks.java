...
public class NpcTasks {
	...
	public enum NpcTaskData {
		...
		KILL_50_SHADOWLORD("Kill 50 Shadowlord", 65607, "Some Gear", new int[] { 0, 50 }, "Kill 50 shadowlord @ ::train", "", "",
				"", new Item[] { new Item(15373, 1),new Item(989, 2), new Item(13727, 20) }), // 14484 is itemid, 1 is amount

		KILL_100_LIGHTREAPERS("Kill 100 Lightreapers", 65608, "Some Gear", new int[] { 1, 100 }, "Kill 100 Lightreapers",
				"Find them in starter teleports", "", "",
				new Item[] { new Item(15373, 1), new Item(989, 3), new Item(10835, 50) }),
		KILL_150_SIRENIC_OGRES("Kill 150 Sirenic Ogres", 65609, "Good Gear", new int[] { 2, 150 },
		...
		KILL_300_JINNIS("Kill 300 Jinnis", 65611, "Decent Gear", new int[] { 4, 300 },
				"Kill 50 300 Jinnis", "Find them in medium teleports", "Mass Boss", "",
				new Item[] { new Item(6199, 2),new Item(1543, 2), new Item(10835, 150) }),
		KILL_250_GREAT_OLMS("Kill 250 Great Olms", 65612, "Decent Gear", new int[] { 5, 250 }, "Kill 250 Demonic Olms",
				"Find them in the medium teleports", "Mass Boss", "",
				new Item[] { new Item(6199, 2), new Item(10835, 250), new Item(13727, 50),new Item(1543, 2), }),
		KILL_50_BLOATED_INFERNALS("Kill 50 Bloated infernals", 65613, "Desent Gear", new int[] { 6, 50 },
				"Kill 50 Bloated infernals", "Find them in medium teleports", "Mass Boss", "",
				new Item[] { new Item(10835, 100), new Item(13727, 100), new Item(6199, 1) }),
		KILL_500_ZEUS("Kill 500 Zeus", 65614, "Desent Gear", new int[] { 7, 500 }, "Kill 500 Zeus", "Find them at medium teleports",
				"Mass Boss", "",
				new Item[] { new Item(10835, 200), new Item(6199, 2), new Item(13727, 75) }),
		KILL_50_INFARTICO("Kill 50 Infartico", 65615, "Decent Gear", new int[] { 8, 50 },
				...
				new Item[] { new Item(10835, 100), new Item(13727, 30) }),
		KILL_500_DARTH_VADER("Kill 500 Darth Vader", 65616, "Decent Gear", new int[] { 9, 500 }, "Kill 500 Darth Vaders",
				"Find them at medium teleports", "Mass Boss", "",
				new Item[] { new Item(10835, 100), new Item(13727, 10) }),
		KILL_5000_DARTH_VADER("Kill 5000 Darth Vaders", 65617, "Desent Gear", new int[] { 10, 5000 },
				"Kill 5000 Darth Vaders", "Find them at hardened teleports", "Mass Boss", "",
				new Item[] { new Item(10835, 500), new Item(13727, 100), new Item(19935, 1) }),
		KILL_500_DANTES_SATAN("Kill 500 Dantes Satans", 65618, "Desent Gear", new int[] { 11, 500 }, "Kill 500 Dantes Satans",
				"Find them at hardened teleports", "Mass Boss", "",
				new Item[] { new Item(10835, 1), new Item(10835, 500), new Item(13727, 10), new Item(6199, 1) }),
		KILL_3000_DANTES_SATAN("Kill 3000 Dantes Satans", 65619, "Decent Gear", new int[] { 12, 3000 }, "Kill 3000 Dantes Satans",
				"Find them at hardened teleports", "", "",
				new Item[] { new Item(19935, 1), new Item(10835, 250),new Item(3988, 1), new Item(13727, 25) }),
		KILL_500_RICK("Kill 500 Ricks", 65620, "Decent Gear", new int[] { 13, 500 },
				"Kill 500 Ricks", "Find them at hardened teleports", "", "",
				new Item[] { new Item(10835, 100), new Item(13727, 15) }),
		KILL_3000_RICK("Kill 3000 Ricks", 65621, "Decent Gear", new int[] { 14, 3000 }, "Kill 3000 Ricks",
				"Find them at hardened teleports", "", "",
				new Item[] { new Item(10835, 1000), new Item(13727, 150),new Item(3988, 1) }),
		KILL_50_KINGKONG("Kill 50 King Kong", 65622, "Some Gear", new int[] { 15, 50 }, "Kill 50 King Kong",
				"Find them at hardened teleports", "", "",
				new Item[] { new Item(19935, 1), new Item(13727, 15),new Item(3988, 1) }),
		KILL_500_KINGKONG("Kill 500 King Kong", 65623, "Some Gear", new int[] { 16, 500 }, "Kill 500 King Kong",
				"Find them in hardened teleport", "", "",
				new Item[] { new Item(10835, 200), new Item(13727, 15),new Item(3988, 1) }),
		KILL_50_CORP_BEAST("Kill 50 Corp beasts", 65624, "Some Gear", new int[] { 17, 50 }, "Kill 50 Corp beasts",
				"Find them at hardened teleports", "", "",
				new Item[] { new Item(10835, 100), new Item(13727, 35) }),
		KILL_500_CORP_BEAST("kill 500 Corp beasts", 65625, "Decent Gear", new int[] { 18, 500 }, "Kill 500 Corp beasts",
				"Find them at hardened teleports", "", "",
				new Item[] { new Item(10835, 350),new Item(19935, 1), new Item(13727, 50),new Item(3988, 1) }),
		KILL_2500_CORP_BEAST("kill 2500 Corp Beasts", 65626, "Decent Gear", new int[] { 19, 2500 }, "Kill 2500 Corp beasts",
				"Find them at hardened teleports", "", "",
				new Item[] { new Item(19936, 1), new Item(13727, 150),new Item(3988, 1) }),
		KILL_500_LUCID_DRAGONS("kill 500 Lucid Dragons", 65627, "Decent Gear", new int[] { 20, 500 },
				"Kill 500 Lucid Dragons", "Find them at hardened teleports", "", "",
				new Item[] { new Item(10835, 170), new Item(13727, 75) }),
		KILL_2500_LUCID_DRAGONS("kill 2500 Lucid Dragons", 65628, "Decent Gear", new int[] { 21, 2500 },
				"Kill 2500 Lucid Dragons", "Find them at hardened teleports", "", "",
				new Item[] { new Item(10835, 350), new Item(13727, 55), new Item(19935, 1),new Item(3988, 1) }),
		KILL_10000_LUCID_DRAGONS("kill 10000 Lucid Dragons", 65629, "Decent Gear", new int[] { 22, 10000 },
				"Kill 10000 Lucid Dragons", "Find them at hardened teleports", "Mass Boss", "",
		...
		KILL_500_DARK_WIZARDS("kill 500 Dark wizards", 65632, "Decent Gear", new int[] { 25, 500 }, "Kill 500 Darkblue wizards",
				"Find them at Expert teleports", "", "",
				new Item[] { new Item(10835, 100), new Item(13727, 50),new Item(3988, 1) }),
		KILL_2500_DARK_WIZARDS("Kill 2500 Dark Wizards", 65633, "Decent Gear", new int[] { 26, 2500 },
				"Kill 2500 Dark Wizards", "Find them at Expert teleports", "", "",
				new Item[] { new Item(10835, 200), new Item(19935, 1), new Item(13727, 100),new Item(3988, 1) }),
		KILL_10000_HEATED_PYRO("Kill 10000 Heated pyro", 65634, "Decent Gear", new int[] { 27, 10000 }, "Kill 10000 Heated pyros",
				"Find them at Expert teleports", "", "",
				new Item[] { new Item(16455, 1), new Item(10835, 500),new Item(3988, 1) }),
		KILL_2500_WYRM("kill 10000 Darkfire Wyrm", 65635, "Decent Gear", new int[] { 28, 2500 },
				"Kill 2500 Darkfire wyrm", "Find them at Expert teleports", "", "",
				new Item[] {new Item(19936, 1), new Item(10835, 500) }),
		KILL_5000_WYRM("kill 5000 Darkfire wyrm", 65636, "Decent Gear", new int[] { 29, 5000 },
				...
				new Item[] { new Item(16455, 1), new Item(10835, 100),new Item(3988, 1) }),
		...
		KILL_5000_TRINITY("Kill 5000 Trinity", 65638, "Decent Gear", new int[] { 31, 5000 }, "Kill 5000 Trinity",
				"Find them at Expert teleports", "", "",
				new Item[] { new Item(13727, 100),new Item(3988, 1),
		...
		KILL_2500_CLOUD("Kill 2500 Cloud", 65639, "Decent Gear", new int[] { 32, 2500 },
				...
				new Item[] { new Item(13727, 100), new Item(10835, 100), new Item(19935, 1) }),
		KILL_5000_CLOUD("kill 5000 Cloud", 65640, "Decent Gear", new int[] { 33, 5000 },
				"Kill 5000 Cloud", "Find them at Expert teleports", "", "",
				new Item[] { new Item(10835, 200), new Item(13727, 100),new Item(3988, 1) }),
		KILL_5000_HERBAL_ROGUE("Kill 5000 Herbal Rogue", 65641, "Some Gear", new int[] { 34, 5000 },
				...
				new Item[] { new Item(10835, 5000), new Item(16455, 1), new Item(13727, 100) }),
		...
		KILL_10000_EXODEN("Kill 10000 Exoden", 65644, "Some Gear", new int[] { 38, 10000 }, "Kill 10000 Exoden",
				"Find them at Expert teleports", "", "",
				new Item[] { new Item(16455, 1), new Item(10835, 1000),new Item(3988, 2) }),
		...
		KILL_10000_SUPREME_NEX("Kill 10000 Supreme Nex", 65647, "Some Gear", new int[] { 41, 10000 }, "Kill 10000 Supreme Nex",
				"Find them at Expert teleports", "", "",
				new Item[] { new Item(5130, 10), new Item(10835, 5000), new Item(16455, 1),new Item(3988, 2) ,new Item(15374, 3)}),
		
		KILL_1000_STORMBREAKERS("Kill 1000 Stormbreakers", 65648, "Some Gear", new int[] { 42, 1000 }, "Kill 1000 Stormbreakers",
				"Find them at Expert teleports", "", "",
				new Item[] { new Item(13997, 1), new Item(10835, 5000), new Item(16455, 1)}),
		
		KILL_5000_STORMBREAKERS("Kill 10000 Supreme Nex", 65649, "Some Gear", new int[] { 43, 5000 }, "Kill 10000 Stormbreakers",
				"Find them at Expert teleports", "", "",
				new Item[] { new Item(13997, 1), new Item(10835, 10000), new Item(19938, 1)}),
		
		KILL_10000_STORMBREAKERS("Kill 10000 Supreme Nex", 65650, "Some Gear", new int[] { 44, 10000 }, "Kill 10000 Stormbreakers",
				"Find them at Expert teleports", "", "",
				new Item[] { new Item(13997, 2), new Item(10835, 15000), new Item(19938, 2)}),
		KILL_1000_APOLLO_RANGERS("Kill 1000 Apollo Rangers", 65651, "Some Gear", new int[] { 45, 1000 }, "Kill 1000 Apollo Rangers",
				"Find them at Expert teleports", "", "",
				new Item[] { new Item(13997, 1), new Item(10835, 5000), new Item(16455, 1)}),
		
		KILL_5000_APOLLO_RANGERS("Kill 10000 Apollo Rangers", 65652, "Some Gear", new int[] { 46, 5000 }, "Kill 5000 Apollo Rangers",
				"Find them at Expert teleports", "", "",
				new Item[] { new Item(5266, 1), new Item(10835, 10000), new Item(19938, 1)}),
		
		KILL_10000_APOLLO_RANGERS("Kill 10000 Apollo Rangers", 65653, "Some Gear", new int[] { 47, 10000 }, "Kill 10000 Apollo Rangers",
				"Find them at Expert teleports", "", "",
				new Item[] { new Item(5266, 2), new Item(10835, 15000), new Item(19938, 2)}),
		
		KILL_1000_NOXIOUS_TROLLS("Kill 1000 Noxious trolls", 65651, "Some Gear", new int[] { 48, 1000 }, "Kill 1000 Noxious trolls",
				"Find them at Expert teleports", "", "",
				new Item[] { new Item(5266, 1), new Item(10835, 5000), new Item(16455, 1)}),
		
		KILL_5000_NOXIOUS_TROLLS("Kill 5000 Noxious trolls", 65652, "Some Gear", new int[] { 49, 5000 }, "Kill 5000 Noxious trolls",
				"Find them at Expert teleports", "", "",
				new Item[] { new Item(5266, 2), new Item(10835, 10000), new Item(19938, 1)}),
		
		KILL_10000_NOXIOUS_TROLLS("Kill 10000 Noxious trolls", 65653, "Some Gear", new int[] { 50, 10000 }, "Kill 10000 Noxious trolls",
				"Find them at Expert teleports", "", "",
				new Item[] { new Item(5266, 3), new Item(10835, 15000), new Item(19938, 2)}),
		
		KILL_1000_AZAZEL_BEAST("Kill 1000 Azazel Beasts", 65651, "Some Gear", new int[] { 51, 1000 }, "Kill 1000 Azazel Beasts",
				"Find them at Expert teleports", "", "",
				new Item[] { new Item(5266, 1), new Item(10835, 5000), new Item(16455, 1)}),
		
		KILL_5000_AZAZEL_BEAST("Kill 5000 Azazel Beasts", 65652, "Some Gear", new int[] { 52, 5000 }, "Kill 5000 Azazel Beasts",
				"Find them at Expert teleports", "", "",
				new Item[] { new Item(5266, 2), new Item(10835, 10000), new Item(19938, 1)}),
		
		KILL_10000_AZAZEL_BEAST("Kill 10000 Azazel Beasts", 65653, "Some Gear", new int[] { 53, 10000 }, "Kill 10000 Azazel Beasts",
				"Find them at Expert teleports", "", "",
				new Item[] { new Item(5266, 3), new Item(10835, 15000), new Item(19938, 2)}),
		
		KILL_1000_RAVANA("Kill 1000 Ravana", 65654, "Some Gear", new int[] { 54, 1000 }, "Kill 1000 Ravana",
				"Find them at Expert teleports", "", "",
				new Item[] { new Item(5266, 1), new Item(10835, 7500), new Item(16455, 1)});
