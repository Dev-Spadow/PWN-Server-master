...
public class KeyRoom {
	...
	private static int[] BEGINNER = { 19871,15693,15251,3912, };
	private static int[] DECENT = { 15373, 20002, 20001, 20000, 12926, 10835, 11605 };
	private static Item[] BEST = { new Item(15373, 1), new Item(20002, 1), new Item(20001, 1), new Item(20000, 1), new Item(12926, 1), new Item(5130, 1), new Item(15373, 1), new Item(15373, 1), new Item(15373, 1), new Item(15373, 1), new Item(15373, 1), new Item(15373, 1), new Item(15373, 1), new Item(15373, 1), new Item(18768, 1), new Item(16455, 1), new Item(3072, 1), new Item(10835, 5), new Item(11605, 5) };
