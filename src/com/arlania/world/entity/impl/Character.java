...
public abstract class Character extends Entity {
    ...
    public void dealDamage(Hit hit) {
        if (getUpdateFlag().flagged(Flag.SINGLE_HIT)) {
        	//System.out.println("AAAAAAAAAAAAA "+hit.getDamage());
    ...
    public Character moveTo(Position teleportTarget) {
        ...
        //}
    	 ...
    	 if(isPlayer()) {
             ...
             if(player.isJailed()) {
                 player.sendMessage("@red@You can't teleport while being jailed");
                 return this;
             }
         }
	...
	private int attacksToBlind = 0;

	public void blindNextAttack(int amount) {
		attacksToBlind = amount;
	}

	public void decrementAttacksToBlind() {
		attacksToBlind -= 1;
	}

	public int getAttacksToBlind() {
		return attacksToBlind;
	}
}
