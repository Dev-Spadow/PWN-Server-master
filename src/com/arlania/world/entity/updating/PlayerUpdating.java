...
public class PlayerUpdating {
	...
	private static void updateChat(PacketBuilder builder, Player target) {
		...
		System.out.println("target.getRights().ordinal(): " + target.getRights().getIcon());
		System.out.println("target.getGameMode().ordinal(): " + target.getGameMode().ordinal());
		builder.put(target.getRights().getIcon());
	...
	private static void updateAppearance(Player player, PacketBuilder out, Player target) {
		...
		if (player.getNpcTransformationId() <= 0) {
			...
			boolean allowOverride = target.overrideItems[Equipment.HEAD_SLOT] > 0 && target.isAllowedToOverride();
			if (equip[Equipment.HEAD_SLOT] > -1 || allowOverride) {
				int id = equip[Equipment.HEAD_SLOT];
				if (allowOverride)
					id = target.overrideItems[Equipment.HEAD_SLOT];

				properties.putShort(0x200 + id);
			} else {
				properties.put(0);
			}

			allowOverride = target.overrideItems[Equipment.CAPE_SLOT] > 0 && target.isAllowedToOverride();
			if (equip[Equipment.CAPE_SLOT] > -1 || allowOverride) {
				int id = equip[Equipment.CAPE_SLOT];
				if (allowOverride)
					id = target.overrideItems[Equipment.CAPE_SLOT];
			...
			allowOverride = target.overrideItems[Equipment.AMULET_SLOT] > 0 && target.isAllowedToOverride();
			if (equip[Equipment.AMULET_SLOT] > -1 || allowOverride) {
				int id = equip[Equipment.AMULET_SLOT];
				if (allowOverride)
					id = target.overrideItems[Equipment.AMULET_SLOT];
			...
			allowOverride = target.overrideItems[Equipment.WEAPON_SLOT] > 0 && target.isAllowedToOverride();
			if (equip[Equipment.WEAPON_SLOT] > -1 || allowOverride) {
				int id = equip[Equipment.WEAPON_SLOT];
				if (allowOverride)
					id = target.overrideItems[Equipment.WEAPON_SLOT];
			...
			allowOverride = target.overrideItems[Equipment.BODY_SLOT] > 0 && target.isAllowedToOverride();
			if (equip[Equipment.BODY_SLOT] > -1 || allowOverride) {
				int id = equip[Equipment.BODY_SLOT];
				if (allowOverride)
					id = target.overrideItems[Equipment.BODY_SLOT];
			...
			allowOverride = target.overrideItems[Equipment.SHIELD_SLOT] > 0 && target.isAllowedToOverride();
			if (equip[Equipment.SHIELD_SLOT] > -1 || allowOverride) {
				int id = equip[Equipment.SHIELD_SLOT];
				if (allowOverride)
					id = target.overrideItems[Equipment.SHIELD_SLOT];
			...
			allowOverride = target.overrideItems[Equipment.BODY_SLOT] > 0 && target.isAllowedToOverride();
			if (ItemDefinition
					.forId(allowOverride ? target.overrideItems[Equipment.BODY_SLOT] : equip[Equipment.BODY_SLOT])
					.isFullBody()) {
				properties.put(0);
			} else {
			...
			allowOverride = target.overrideItems[Equipment.LEG_SLOT] > 0 && target.isAllowedToOverride();
			if (equip[Equipment.LEG_SLOT] > -1 || allowOverride) {
				int id = equip[Equipment.LEG_SLOT];
				if (allowOverride)
					id = target.overrideItems[Equipment.LEG_SLOT];
			...
			allowOverride = target.overrideItems[Equipment.HEAD_SLOT] > 0 && target.isAllowedToOverride();
			if (ItemDefinition
					.forId(allowOverride ? target.overrideItems[Equipment.HEAD_SLOT] : equip[Equipment.HEAD_SLOT])
					.isFullHelm()) {
				properties.put(0);
			} else {
			...
			allowOverride = target.overrideItems[Equipment.HANDS_SLOT] > 0 && target.isAllowedToOverride();
			if (equip[Equipment.HANDS_SLOT] > -1 || allowOverride) {
				int id = equip[Equipment.HANDS_SLOT];
				if (allowOverride)
					id = target.overrideItems[Equipment.HANDS_SLOT];
			...
			allowOverride = target.overrideItems[Equipment.FEET_SLOT] > 0 && target.isAllowedToOverride();
			if (equip[Equipment.FEET_SLOT] > -1 || allowOverride) {
				int id = equip[Equipment.FEET_SLOT];
				if (allowOverride)
					id = target.overrideItems[Equipment.FEET_SLOT];
			...
			allowOverride = target.overrideItems[Equipment.AURA_SLOT] > 0 && target.isAllowedToOverride();
			if (equip[Equipment.AURA_SLOT] > -1 || allowOverride) {
				int id = equip[Equipment.AURA_SLOT];
				if (allowOverride)
					id = target.overrideItems[Equipment.AURA_SLOT];
		...
		properties.putShort(target.getRights().getIcon());
		properties.putString(target.getTitle());
		properties.put(target.isMiniPlayer() ? 1 : 0);
