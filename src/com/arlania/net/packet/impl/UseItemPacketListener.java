...
public class UseItemPacketListener implements PacketListener {
	...
	private static void itemOnItem(Player player, Packet packet) {
		...
		KeepSake.useKey(player, usedWith.getId(), itemUsedWith.getId());
		...
		if (itemUsedWith.getId() >= 4670 && itemUsedWith.getId() <= 4673
				&& usedWith.getDefinition().getEquipmentSlot() == Equipment.WEAPON_SLOT) {
			if (player.getInventory().getAmount(itemUsedWith.getId()) >= 50)
				player.getItemEnchantments().addEnchantment(player, itemUsedWith.getId(), usedWith.getId());
		}
		if (LootingBag.useWithLootingBag(player, itemUsedWith.getId(), usedWith.getId(), itemUsedSlot, usedWithSlot)) {
			System.out.println("lootingbag");
			return;
		}

		
		if (usedWith.getId() == 6191 && itemUsedWith.getId() == 9943) {
			player.getPacketSender().sendMessage("You pack the oz of weed inside the bong, time to get high!");
			player.getInventory().delete(6191, 1);
			player.getInventory().delete(9943, 1);
			player.getInventory().add(6192, 1);
			return;
	}
		
		if (usedWith.getId() == 12631 && itemUsedWith.getId() == 954) {
			player.getPacketSender().sendMessage("You craft a Ghostspeak paperboat amulet");
			player.getPacketSender().sendMessage("You can equip this amulet to interact with the ghost of georgie at home now!");
			player.getInventory().delete(12631, 1);
			player.getInventory().delete(954, 1);
			player.getInventory().add(552, 1);
			return;
	}
		if (usedWith.getId() == 954 && itemUsedWith.getId() == 12631) {
			player.getPacketSender().sendMessage("You craft a Ghostspeak paperboat amulet");
			player.getPacketSender().sendMessage("You can equip this amulet to interact with the ghost of georgie at home now!");
			player.getInventory().delete(12631, 1);
			player.getInventory().delete(954, 1);
		...
		if (usedWith.getId() == 18022 || itemUsedWith.getId() == 18023) {
			player.getPacketSender().sendMessage("To make an Amulet of Fury, you need to put an onyx in a furnace.");
			return;
		}
		
		//Namek complete dbz set
		if (usedWith.getId() == 20575 && itemUsedWith.getId() == 20576 && itemUsedWith.getId() == 20577 && itemUsedWith.getId() == 20578
				&& itemUsedWith.getId() == 20579 && itemUsedWith.getId() == 20580 && itemUsedWith.getId() == 20581) {
			if (!player.getInventory().contains(20575)) 
			if(!player.getInventory().contains(20576))
				if(!player.getInventory().contains(20577))
					if(!player.getInventory().contains(20578))
						if(!player.getInventory().contains(20579))
							if(!player.getInventory().contains(20580))
								if(!player.getInventory().contains(20581)){
				player.sendMessage("You don't have all the Namek Dragonballz to make the complete set.");
				return;
			}
				player.getInventory().deleteItems(20575, 20576, 20577, 20578,20579,20580,20581);
				player.getInventory().add(20582, 1);
				player.sendMessage("@blu@Congratulations, you made the Namek Complete set");
		}
	...
	private static void itemOnNpc(final Player player, Packet packet) {
		...
		switch (index) {
		case 16:
			if (player.getInventory().contains(12162)) {
				player.incrementZeusKC(100);
				player.getInventory().delete(12162, 1);
			}
				break;
		case 11:
			if (player.getInventory().contains(12162)) {
				player.incrementValorKC(100);
				player.getInventory().delete(12162, 1);
			}
				break;
		case 6303:
			if (player.getInventory().contains(12162)) {
				player.incrementHwKC(100);
				player.getInventory().delete(12162, 1);
			}
				break;
		case 9273:
			if (player.getInventory().contains(12162)) {
				player.incrementDzanthKC(100);
				player.getInventory().delete(12162, 1);
			}
				break;
		case 9203:
			if (player.getInventory().contains(12162)) {
				player.incrementKongKC(100);
				player.getInventory().delete(12162, 1);
			}
				break;
		case 9247:
			if (player.getInventory().contains(12162)) {
				player.incrementLucidKC(100);
				player.getInventory().delete(12162, 1);
			}
				break;
		case 8493:
			if (player.getInventory().contains(12162)) {
				player.incrementHulkKC(100);
				player.getInventory().delete(12162, 1);
			}
				break;
		case 172:
			if (player.getInventory().contains(12162)) {
				player.incrementPyroKC(100);
				player.getInventory().delete(12162, 1);
			}
				break;
		case 9935:
			if (player.getInventory().contains(12162)) {
				player.incrementWyrmKC(100);
				player.getInventory().delete(12162, 1);
			}
				break;
		case 170:
			if (player.getInventory().contains(12162)) {
				player.incrementTrinityKC(100);
				player.getInventory().delete(12162, 1);
			}
				break;
		case 219:
			if (player.getInventory().contains(12162)) {
				player.incrementHerbalKC(100);
				player.getInventory().delete(12162, 1);
			}
				break;
		case 12239:
			if (player.getInventory().contains(12162)) {
				player.incrementExodenKC(10000);
				player.getInventory().delete(12162, 1);
			}
				break;
		case 527:
			if (player.getInventory().contains(12162)) {
				player.incrementBreakerKC(100);
				player.getInventory().delete(12162, 1);
			}
				break;
		case 1684:
			if (player.getInventory().contains(12162)) {
				player.incrementApolloKC(100);
				player.getInventory().delete(12162, 1);
			}
				break;
		case 5957:
			if (player.getInventory().contains(12162)) {
				player.incrementNoxKC(100);
				player.getInventory().delete(12162, 1);
			}
				break;
		case 5958:
			if (player.getInventory().contains(12162)) {
				player.incrementAzazelKC(100);
				player.getInventory().delete(12162, 1);
			}
				break;
		case 5959:
			if (player.getInventory().contains(12162)) {
				player.incrementRavanaKC(100);
				player.getInventory().delete(12162, 1);
			}
				break;
		case 185:
			if (player.getInventory().contains(12162)) {
				player.incrementLuminKC(100);
				player.getInventory().delete(12162, 1);
			}
				break;
		case 6311:
			if (player.getInventory().contains(12162)) {
				player.incrementCustomhKC(100);
				player.getInventory().delete(12162, 1);
			}
				break;
		case 2907:
			if (player.getInventory().contains(12162)) {
				player.incrementRazorKC(100);
				player.getInventory().delete(12162, 1);
			}
				break;
		case 20:
			if (player.getInventory().contains(12162)) {
				player.incrementDreamflowKC(100);
				player.getInventory().delete(12162, 1);
			}
				break;
		case 259:
			if (player.getInventory().contains(12162)) {
				player.incrementKhioneKC(100);
				player.getInventory().delete(12162, 1);
			}
				break;
		case 1123:
			if (player.getInventory().contains(12162)) {
				player.incrementSableKC(100);
				player.getInventory().delete(12162, 1);
			}
				break;
		case 12835:
			if (player.getInventory().contains(12162)) {
				player.incrementDemoKC(100);
				player.getInventory().delete(12162, 1);
			}
				break;
		case 8548:
			if (player.getInventory().contains(12162)) {
				player.incrementYoshiKC(100);
				player.getInventory().delete(12162, 1);
			}
				break;
		case 2264:
			if (player.getInventory().contains(12162)) {
				player.incrementAvatarKC(100);
				player.getInventory().delete(12162, 1);
			}
				break;
		case 11360:
			if (player.getInventory().contains(12162)) {
				player.incrementLiliKC(100);
				player.getInventory().delete(12162, 1);
			}
				break;
		case 11383:
			if (player.getInventory().contains(12162)) {
				player.incrementObitoKC(100);
				player.getInventory().delete(12162, 1);
			}
				break;
		case 11305:
			if (player.getInventory().contains(12162)) {
				player.incrementUruKC(100);
				player.getInventory().delete(12162, 1);
			}
				break;
		case 5931:
			if (player.getInventory().contains(12162)) {
				player.incrementKumihoKC(100);
				player.getInventory().delete(12162, 1);
			}
				break;
		case 367:
	...
	public static boolean isGambleable(Player player, int itemId) {
		List<Integer> notGambleAbleItems = Arrays.asList(19475, 19476, 19477, 19478, 19936, 19938, 19935,16453,16454,16455, 16455, 3820,
