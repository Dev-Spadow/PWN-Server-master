...
public final class WeaponInterfaces {
	...
	public enum WeaponInterface {
		STAFF(328, 331, 0, new FightType[] { FightType.STAFF_BASH, FightType.STAFF_POUND, FightType.STAFF_FOCUS }),
				WARHAMMER(425, 428, 0, new FightType[] { FightType.WARHAMMER_POUND,
				...
				//Fastest Speed
				FASTSPEED(2276, 2279, 0, new FightType[] { FightType.SWORD_STAB,
						FightType.SWORD_LUNGE, FightType.SWORD_SLASH,
						FightType.SWORD_BLOCK }, 7574, 7586),
				// Second fastest
				FASTSPEED1(2276, 2279, 0, new FightType[] { FightType.SWORD_STAB,
						FightType.SWORD_LUNGE, FightType.SWORD_SLASH,
						FightType.SWORD_BLOCK }, 7574, 7586),
				//Third fastest
				FASTSPEED2(2276, 2279, 0, new FightType[] { FightType.SWORD_STAB,
						FightType.SWORD_LUNGE, FightType.SWORD_SLASH,
						FightType.SWORD_BLOCK }, 7574, 7586),
				//Fourth fastest
				
				FASTSPEED3(2276, 2279, 0, new FightType[] { FightType.SWORD_STAB,
						FightType.SWORD_LUNGE, FightType.SWORD_SLASH,
						FightType.SWORD_BLOCK }, 7574, 7586),
																										...
																										KNIFE(4446, 4449, 0, new FightType[] { FightType.KNIFE_ACCURATE,
																												...
																												SPEAR(4679, 4682, 0, new FightType[] { FightType.SPEAR_LUNGE,
																														...
																														TWO_HANDED_SWORD(4705, 4708, 0, new FightType[] {
																																...
																																PICKAXE(5570, 5573, 0, new FightType[] { FightType.PICKAXE_SPIKE,
																																		FightType.PICKAXE_IMPALE, FightType.PICKAXE_SMASH,
																																		FightType.PICKAXE_BLOCK }),
																																		CLAWS(7762, 7765, 0, new FightType[] { FightType.CLAWS_CHOP,
																																				FightType.CLAWS_SLASH, FightType.CLAWS_LUNGE,
																																				FightType.CLAWS_BLOCK }, 7800, 7812),
																																				HALBERD(8460, 8463, 0, new FightType[] { FightType.HALBERD_JAB,
																																						...
																																						UNARMED(5855, 5857, 6, new FightType[] { FightType.UNARMED_PUNCH,
																																								...
																																								WHIP(12290, 12293, 0, new FightType[] { FightType.WHIP_FLICK,
																																										FightType.WHIP_LASH, FightType.WHIP_DEFLECT }, 12323, 12335),
																																										THROWNAXE(4446, 4449, 0, new FightType[] {
																																												FightType.THROWNAXE_ACCURATE, FightType.THROWNAXE_RAPID,
																																												FightType.THROWNAXE_LONGRANGE }, 7649, 7661),
																																												DART(4446, 4449, 0, new FightType[] { FightType.DART_ACCURATE,
																																														FightType.DART_RAPID, FightType.DART_LONGRANGE }, 7649, 7661),
																																														JAVELIN(4446, 4449, 0, new FightType[] { FightType.JAVELIN_ACCURATE,
