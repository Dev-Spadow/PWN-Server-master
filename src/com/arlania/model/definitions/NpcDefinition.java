	...
	public static JsonLoader parseNpcs() {
		return new JsonLoader() {
			...
			public void load(JsonObject reader, Gson builder) {
				...
				definitions[index].setMaxHit((int) (reader.get("maxHit").getAsInt() * 0.1));
				if (index != 10010 || index != 2005 || index != 9911 || index != 12802 || index != 25 || index != 2509 || index != 4543 || index != 4595) {
					definitions[index].setHitpoints((int) (reader.get("hitpoints").getAsInt() * 0.05));
				} else {
				...
				definitions[index].setAttackBonus((int) (reader.get("attackBonus").getAsInt() * 0.1));
				definitions[index].setDefenceMelee((int) (reader.get("defenceMelee").getAsInt() * 0.1));
				definitions[index].setDefenceRange((int) (reader.get("defenceRange").getAsInt() * 0.1));
				definitions[index].setDefenceMage((int) (reader.get("defenceMage").getAsInt() * 0.1));
